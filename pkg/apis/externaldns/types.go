...
var defaultConfig = &Config{
	...
	AWSZoneCacheDuration:        600 * time.Second,
...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("aws-zones-cache-duration", "When using the AWS provider, set the zones list cache TTL.").Default(defaultConfig.AWSZoneCacheDuration.String()).DurationVar(&cfg.AWSZoneCacheDuration)
